...
if (userAnswer.answer === myPinCode) {
    ...
    if (user_operation_Answer.operation === "fast cash") {
        ...
        if (user_selectedAmount.selectamount === "1000") {
            console.log(myCurrentBalance - user_selectedAmount.selectamount);
        }
        else if (user_selectedAmount.selectamount === "2000") {
            console.log(`Your Remaining Balance ${myCurrentBalance - user_selectedAmount.selectamount}`);
        }
        else if (user_selectedAmount.selectamount === "5000") {
            console.log(`Your Remaining Balance ${myCurrentBalance - user_selectedAmount.selectamount}`);
        }
        else if (user_selectedAmount.selectamount === "10000") {
            console.log(`Your Remaining Balance ${myCurrentBalance - user_selectedAmount.selectamount}`);
        }
    }
    ...
    console.log("You Entered Incorrect Code");
}
